...
let { icons, i_p_wrapper, i_p_div_1, i_p_div_2, i_p_div_3, i_p_div_4, i_p_label, i_p_input_search, i_p_tabitem_div_1, i_p_tabitem_div_2, i_p_input_range, i_p_tabs, title, sizeByTailwind, minSize = "16", defaultSize = "24", maxSize = "48", threeTabs = true } = $props();
