<script lang="ts">
  import { CodeWrapper, Code, H1, H2, H3 } from "$lib";
...
<HighlightCompo lang="ts" code={modules["./md/withevents.md"] as string} />
...
<HighlightCompo lang="ts" code={modules["./md/withevents-2.md"] as string} />
