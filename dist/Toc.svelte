...
<div class="relative">
  ...
  >
    {#if headings.length}
      <div
        class="flex overflow-y-auto sticky top-12 flex-col justify-between pb-6 h-[calc(100vh-5rem)]"
      >
        <div class="mb-8">
          <h4
            class="pl-2.5 my-4 text-sm font-semibold tracking-wide text-gray-900 uppercase dark:text-white"
          >
            On this page
          </h4>
          <nav>
