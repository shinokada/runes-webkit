...
<List tag="dl" ctxClass='my-1'>
  ...
  <Li><Checkbox inline />change <Code>.git</Code> directory and check if it is <Code>svelte-5-runes</Code> branch</Li>
  ...
  <Li><Checkbox inline />Use global search to replace runes-webkit-starter with your package name</Li>
  <Li><Checkbox inline />Remove or change the name of three-tabs, three-tabs-sizedbytailwind, and no-tabs directories</Li>
  ...
  <Li><Checkbox inline />Remove unnecessary directories, awesome-samples, flowbite-samples, guide2, how-to-use, quick-start, supertiny-samples.</Li>
