...
import flowbiteSeltePackage from './node_modules/flowbite-svelte/package.json' with { type: 'json' };
...
export default defineConfig({
  ...
  define: {
    ...
    __FLOWBITE_SVELTE_VERSION__: JSON.stringify(flowbiteSeltePackage.version),
