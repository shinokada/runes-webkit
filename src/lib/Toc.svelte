...
@props:extract: any;
@props:div1Class: any = 'hidden w-64 flex-none xl:block xl:text-sm';
@props:div2Class: any = 'dark_bg_theme fixed right-2 flex-none';
@props:div3Class: any = 'flex h-[calc(100vh-168px)] flex-col justify-between overflow-y-auto';
@props:div4Class: any = 'mb-8 p-4';
@props:aClass: any;
@props:classA: any = "inline-block border-l border-white duration-200 hover:text-gray-900 transition-none dark:text-gray-300 dark:hover:text-gray-400 hover:border-gray-300 after:content-['#'] after:text-primary-700 dark:after:text-primary-700 dark:border-gray-900 dark:hover:border-gray-700 after:ml-2 after:opacity-0 hover:after:opacity-100 after:transition-opacity after:duration-100";
@props:ulClass: any = 'space-y-2.5 font-medium text-gray-500 dark:text-gray-400';
@props:h4Class: any;
@props:classH4: any = 'my-4 pl-2.5 text-sm font-semibold uppercase tracking-wide text-gray-900 dark:text-white';
-->
