...
let { children, pkgName, pkgVersion, runeswebkitVersion, runaticsVersion, runesMetaTagsVersion, svelteVersion, svelteKitVersion, svelte5uilib, svelteRuneHighlight, viteVersion, repoUrl, title = "Technical information about this website", h2_class, div_class, ul_class, li_class, a_class, cardsize = "xl" } = $props();
</script>
